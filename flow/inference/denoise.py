...
def main():
    ...
    parser.add_argument('--output', type=str, default='results/denoise/',
                       help='Path to save output image')
    parser.add_argument('--model_path', type=str, default='model/flow_weights.pt',
    ...
    image_tensor = torch.from_numpy(image).float() * 2 / 255.0 - 1
    ...
    print(f"Denoising completed. Result saved to: {args.output}")
