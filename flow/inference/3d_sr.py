...
def main():
    ...
    parser.add_argument('--input', type=str, required=True, help='Path to input volume')
    parser.add_argument('--output_dir', type=str, default='results/3d_sr/', help='Output directory')
    ...
    parser.add_argument('--model_path', type=str, default='model/flow_weights.pt', help='Model weights path')
    ...
    # Load input data
    noised_image = tifffile.imread(args.input)
