...
def main():
    ...
    parser.add_argument('--output', type=str, default='results/2d_sr/', help='Path to save output high-resolution image')
    ...
    lr_image = tifffile.imread(args.input)
    lr_tensor = torch.from_numpy(lr_image).float() * 2 / 255.0 - 1
